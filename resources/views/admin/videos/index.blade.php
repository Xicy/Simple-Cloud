                            ...
                            @endforeach</td>
                                ...
                                <td>
                                    ...
                                    {!! Form::open(array(
                                        ...
                                        'route' => ['admin.files.restore', $video->id])) !!}
                                ...
                                @endcan
								    ...
								    {!! Form::open(array(
                                        ...
                                        'method' => 'DELETE',
                                        'onsubmit' => "return confirm('".trans("quickadmin.qa_are_you_sure")."');",
                                        'route' => ['admin.files.perma_del', $video->id])) !!}
                                ...
                                <td>
                                    @can('video_view')
                                    <a href="{{ route('admin.files.show',[$video->id]) }}" class="btn btn-xs btn-primary">@lang('quickadmin.qa_view')</a>
                                    @endcan
                                    @can('video_edit')
                                    <a href="{{ route('admin.files.edit',[$video->id]) }}" class="btn btn-xs btn-info">@lang('quickadmin.qa_edit')</a>
                                    @endcan
                                    @can('video_delete')
{!! Form::open(array(
                                        'style' => 'display: inline-block;',
                                        'method' => 'DELETE',
                                        'onsubmit' => "return confirm('".trans("quickadmin.qa_are_you_sure")."');",
                                        'route' => ['admin.files.destroy', $video->id])) !!}
